...
def main(args):
    ...
    while True:
        ...
        for i in range(args.Test_Episodes):
            ...
            print(f"iter {iter}, episode {i+1}, reward: {reward}")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--env", type=str, help="the name of environment", default="FrozenLake-v1")
    parser.add_argument("--gamma", type=float, help="The discount factor", default=0.9)
    parser.add_argument("--Test_Episodes", type=int, help="Test_Episodes decided whether stop training", default=10)
